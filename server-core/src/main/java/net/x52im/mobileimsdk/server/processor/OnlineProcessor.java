...
public class OnlineProcessor {
    ...
    public static final AttributeKey<String> ATTRIBUTE_KEY_USER_TOKEN = AttributeKey.newInstance("__user_token__");
    ...
    public static void setUserTokenForChannel(Channel session, String token) {
        session.attr(OnlineProcessor.ATTRIBUTE_KEY_USER_TOKEN).set(token);
    }
    ...
    public static String getUserTokenFromChannel(Channel session) {
        return (session != null ? session.attr(ATTRIBUTE_KEY_USER_TOKEN).get() : null);
    }
    ...
    public static void removeAttributesForChannel(Channel session) {
        ...
        session.attr(OnlineProcessor.ATTRIBUTE_KEY_USER_TOKEN).set(null);
